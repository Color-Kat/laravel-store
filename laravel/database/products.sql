...
(7, "Камера Panasonic HC-V770", "panasonic_hc-v770", 2, NULL, "Для серьёзной видео съемки нужна серьёзная камера.
    Panasonic HC-V770 для этих целей лучший выбор!", 27900, NULL, NULL),
...
(11, "Мясорубка Bosch", "bosch", 3, NULL, "Любите домашние котлеты? Вам определенно стоит посмотреть на эту
    мясорубку!", 9200, NULL, NULL);
