    ...
    public function run()
    {
        DB::table('products')->insert([
            [
                'name' => 'iPhone X 64GB',
                'code' => 'iphone_x_64',
                'description' => 'Отличный продвинутый телефон с памятью на 64 B не ворован!',
                'price' => '71990',
                'category_id' => 1,
            ...
            [
                'name' => 'iPhone X 256GB',
                'code' => 'iphone_x_256',
                'description' => 'Отличный продвинутый телефон с памятью на 256 gb, топ телефон, но своровали, чего греха таить',
                'price' => '89990',
                'category_id' => 1,
            ...
            [
                'name' => 'Парогенератор philips',
                'code' => 'Filiphis_water_warm',
                'description' => 'Для серьезного пара нужен серьезный ковер съерзанный',
                'price' => '217900',
                'category_id' => 3,
                'image' => 'products/video_panasonic.jpg',
                'count' => rand(0, 10)
